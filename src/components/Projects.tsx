    ...
    >
      ...
      <div className="mt-7 flex flex-col gap-4 text-left">
        {projects.map((p) => (
          <div
            key={p.title}
            className="relative overflow-hidden rounded-xl border border-line bg-panel p-4 transition-all hover:-translate-y-1 hover:shadow-2xl"
          ...
          >
            ...
            <div className="mt-4">
              {p.href ? (
                ...
                <span className="inline-block rounded-lg border border-white/10 px-3 py-2 text-sm font-semibold text-muted">
                  Kommer snart
                </span>
              )}
            </div>
